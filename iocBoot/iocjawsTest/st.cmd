...
epicsEnvSet("JAWS_POS_FROM_AS", "N")
...
dbLoadRecords("db/jaws.db","P=$(MYPVPREFIX),JAWS=MOT:JAWS1:,mXN=MOT:MTR0101,mXS=MOT:MTR0102,mXE=MOT:MTR0103,mXW=MOT:MTR0104,IFINIT_FROM_AS=$(IFINIT_JAWS_FROM_AS=#),IFNOTINIT_FROM_AS=$(IFNOTINIT_JAWS_FROM_AS=)")
...
dbLoadRecords("db/jaws.db","P=$(MYPVPREFIX),JAWS=MOT:JAWS2:,mXN=MOT:MTR0105,mXS=MOT:MTR0106,mXE=MOT:MTR0107,mXW=MOT:MTR0108,IFINIT_FROM_AS=$(IFINIT_JAWS_FROM_AS=#),IFNOTINIT_FROM_AS=$(IFNOTINIT_JAWS_FROM_AS=)")
...
dbLoadRecords("db/jaws.db","P=$(MYPVPREFIX),JAWS=MOT:JAWS3:,mXN=MOT:MTR0201,mXS=MOT:MTR0202,mXE=MOT:MTR0203,mXW=MOT:MTR0204,IFINIT_FROM_AS=$(IFINIT_JAWS_FROM_AS=#),IFNOTINIT_FROM_AS=$(IFNOTINIT_JAWS_FROM_AS=)")
...
dbLoadRecords("db/jaws.db","P=$(MYPVPREFIX),JAWS=MOT:JAWS4:,mXN=MOT:MTR0205,mXS=MOT:MTR0206,mXE=MOT:MTR0207,mXW=MOT:MTR0208,IFINIT_FROM_AS=$(IFINIT_JAWS_FROM_AS=#),IFNOTINIT_FROM_AS=$(IFNOTINIT_JAWS_FROM_AS=)")
